...
// PHP Session starten (Passwort-Abfrage)
session_start();
...
width="20" height="20"></a>&nbsp; <a href="aufzeichnung.html">Letzte Aufzeichnung</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

<!-- Infomessage unterhalb der Ueberschrift ausgeben -->
<!-- div class="w3-panel w3-border-left w3-border-green w3-pale-green">

<b>NEU:</b> Gottesdienste mit der <a href="./rksviewer.pdf" target="_blank">RKS-Viewer-Box</a> live und dire$

</div -->

 <form method="post" action="" id="logout_form" style="display:inline;">
    <button type="submit" name="page_logout" value="LOGOUT" style="border:none;">
     <img src="../images/logout.png" width="20" height="20" alt="Logout" title="Logout" />
    </button>
...
<td><a href=\"/".$ort."/showmpeg2.html?filename=".$dateiinfo['filename'].".mp4\"><img src=\"../images/play.png\" 
title=\"Video abspielen\" width=\"20\" height=\"20\"></a></td><td>
<a href=\"/".$ort."streams/".$dateiinfo['filename'].".mp4\" download=\"\/\/".$server."/".$ort."streams/".$dateiinfo['filename'].".mp4\">
...
<!-- Statiskti fuer diese Seite ausgeben -->
<!-- div class="footer" -->
  <!-- p>Footer</p -->
...
<?php
// Klammer schliessen fuer PHP Session
}
else
{
 ?>
...
<?php
  ...
  echo "<form method=\"post\" action=\"\" id=\"login_form\">";
  echo"<div class=\"content\">";
  echo"<h4>Passwort eingeben:</h4>";
  echo"</div>";
  echo"</p>";
  echo"<input type=\"password\" name=\"pass\">";
  echo"<input type=\"submit\" name=\"submit_pass\" value=\"Login\">";
  echo"<p><font style=\"color:red;\">".$error."</font></p>";
  echo"</form>";

// Ende if-Schleife Session
}
?>
