...
<!-- div style="width:100%" class="w3-panel">
   <div style="border:0px solid #000000;padding:2px;width:100%;font-size:80%;font-weight:bold;">
      <img src="../images/counter.gif" width="16" height="16" border="0" /> Besucher Statistik f&uuml;r diese Seite:
   </div>

   <div style="border:0px solid #000000;padding:2px;width:100%;font-size:80%;">
      <Online: <?php echo $online; ?> /
      Heute: <?php echo $day; ?> /
      Gestern: <?php echo $yesterday; ?> /
      Woche: <?php echo $week; ?> /
      Monat: <?php echo $month; ?> /
      Jahr: <?php echo $year; ?> /
      Gesamt: <?php echo $all; ?> /
      <b>Rekord: <?php echo $record; ?> (<?php echo date("d.m.Y", $record_time) ?>)</b>
   </div>

   <div style="border:0px solid #000000;padding:2px;width:100%;font-size:80%;">
      <div style="font-size:50%;" align="left"><a href="http://de.free-php-counter.com" target="_blank">Kostenloser PHP Counter</a></div>
   </div>
</div -->
